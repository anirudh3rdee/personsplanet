                ...
                <div class="row text-center text-xs-center text-sm-left text-md-left">
                    ...
                    <div class="listing-ftr">
                        ...
                        // print_r(json_decode($footermenuData[0]->value));
                            ...
                            <div class="col-md-3">
                               ...
                               foreach ($footersubmenuData as $key) {
                                ...
                                if($value->sub_select_parent=='first_menu'){
                                    ...
                                    <li><a href="<?php if($value->sub_external_link == ''){echo $value->sub_select_link ; } else {echo $value->sub_external_link ; } ?>"><?php echo $parent_menu; ?></a>
                                    </li>
                            ...
                            <div class="col-md-3">
                            <?php
                                    echo "<h6 style='padding-bottom:18px;'>".$secondMenu."</h6>";
                                  ?>
                                   <?php 
                               foreach ($footersubmenuData as $key) {
                                $value=json_decode($key->value);
                                ...
                                if($value->sub_select_parent=='second_menu'){
                                    ...
                                    <ul class="list-unstyled quick-links new_middle">
                                    <li><a href="<?php if($value->sub_external_link == ''){echo $value->sub_select_link ; } else {echo $value->sub_external_link ; } ?>"><?php echo $parent_menu; ?></a>
                                    </li>
