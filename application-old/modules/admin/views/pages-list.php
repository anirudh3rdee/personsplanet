                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a class="btn btn-outline-primary" href="<?php echo base_url('admin/pages/add_new_page/');?>" >Create New</a>
                                		...
                                		<thead>
                                		 ...
                                		 <tbody>
                                		 	...
                                		 	<tr id="row_<?php echo $key->id; ?>">
                                              ...
                                              <?php echo $array_data['bannerhead']; ?>
                                                ...
                                                $pageContent = $array_data['pageContent'];  
                                         ...
                                         <?php endif;?>
                                                ...
                                                <td>
			                                        ...
			                                        <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 35px, 0px);">
			                                          ...
			                                          <a class="dropdown-item" href="<?php echo base_url('admin/pages/add_new_page/'.$key->id);?>">Edit</a>
