            ...
            <div class="auth-box bg-light border-top border-secondary shadow">
                ...
                <div id="loginform">
                    ...
                    <div class="form_erro">
                        ...
                        <div class="alert alert-danger" role="alert"> <?php echo $form_error; ?>
                        ...
                        <div class="row p-b-30">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="u_pass" class="form-control form-control-lg" placeholder="Password" aria-label="Password" aria-describedby="basic-addon1" required="">
