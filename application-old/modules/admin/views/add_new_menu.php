                                ...
                                <div class="card-body">
                                   ...
                                   <div class="row mb-3 align-items-center">
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <input type="radio" name="link_type"  value="internal_link" onclick="selectLink('internal');" <?php if( $link_type=="internal_link"){ echo "checked";}?>> Select Link Type
                                            <input type="radio" name="link_type" value="external_link" onclick="selectLink('external');" <?php if( $link_type=="external_link"){ echo "checked";}?>> External Link
                                        </div>
                                    </div>
