                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive" style='margin-top:10px'>
                                	<table class="table" id="myTable">
                                		 ...
                                		 <tbody>
                                		 <?php if(!empty($footersubmenuData)){
                                            ...
                                            foreach ($footersubmenuData as $key ) {
                                		 	...
                                		 	<tr id="row_<?php echo $key->id; ?>">
                                		 		...
                                		 		<td>
                                		 		    <?php 
                                		 		    $url='';
                                		 		    if($key->valueKey=='sub_internal_link')
                                		 		      {
                                		 		          echo 'Internal Page';
                    ...
                    <div class="modal-body">
                         <form method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/setting/save_footersubmenu/'.$footersubmenuIDD); ?>">
                                    ...
                                    <div class="row mb-3 align-items-center">
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <input type="radio" name="sub_link_type"  value="sub_internal_link" onclick="selectLink('internal');"> Select Link Type
                                            <input type="radio" name="sub_link_type" value="sub_external_link" onclick="selectLink('external');"> External Link
                                        </div>
                                    </div>
