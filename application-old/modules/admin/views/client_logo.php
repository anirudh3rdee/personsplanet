                                		 	...
                                		 	<tr id="row_<?php echo $key->id; ?>">
                                		 		...
                                		 		<td>
			                                        ...
			                                        <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 35px, 0px);">
			                                          ...
			                                          <a class="dropdown-item" href="<?php echo base_url('admin/client_logo/edit_client_logo/'.$key->id);?>">Edit</a>
                         ...
                         <form method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/client_logo/save_client_logo');?>">
                                    ...
                                    <div class="row mb-3 align-items-center">
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            ...
                                            <input type="text" name="title" data-toggle="tooltip" title="" class="form-control" id="validationDefault05" placeholder="Enter Client Logo Title" required="" data-original-title="Enter Client Logo Title">
