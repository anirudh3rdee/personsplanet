                            ...
                            <form method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/setting/save_footersubmenu/'.$footersubmenu_id); ?>">
                                ...
                                <div class="card-body">
                                   ...
                                   <div class="row mb-3 align-items-center">
                                        <label for="sub_link_type" class="col-sm-3 text-right control-label col-form-label">Link Type</label>
                                        <div class="col-lg-8 col-md-12">
                                        
                                            <input type="radio" name="sub_link_type"  value="internal_link" onclick="selectLink('internal');" <?php if( $sub_link_type=="sub_internal_link"){ echo "checked";}?>> Select Link Type
                                            <input type="radio" name="sub_link_type" value="external_link" onclick="selectLink('external');" <?php if( $sub_link_type=="external_link"){ echo "checked";}?>> External Link
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row external" >
