...
class Home extends MY_Controller {
...

	{
        ...
        $home_banner = $this->basicModal->check('settingbypage',array('type'=>'home-page', 'valueKey'=>'banner-section'));
...
public function save_home_bannersection($id=0){
        ...
        if($_FILES['banner_image']['name'] !=''){
           ...
           $metaValueKey['banner_image']=$old_image; 

        }

        $metaValueKey['banner_title']=$_POST['banner_title'];
...

{
    ...
    if( isset( $slide_id) > 0 ) {
        ...
        $data['slideData'] = $this->basicModal->check('settingbypage',array('type'=>'home-page', 'id' => $slide_id));
    ...
    $data['subview'] = $this->load->view('add_edit_slider', $data, true);
...
public function add_edit_review()
    ...
    public function save_video($id=0){
		...
		$dataArray['video_image'] = $_POST['video_image'] ;
		$data['value'] = json_encode($dataArray) ;
