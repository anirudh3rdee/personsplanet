...
//  die;
                if( !empty( $blogData )){
                    ...
                    $shortContent = html_entity_decode($array_data['shortContent']);

                    $fullContent = html_entity_decode($array_data['fullContent']);
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                           ...
                                           <textarea  name="shortContent" class="form-control"><?php echo html_entity_decode($shortContent);?></textarea>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <label for="pageFullContent" class="col-sm-3 text-right control-label col-form-label">Full Content</label>
                                       ...
                                       <div class="col-sm-9">
                                         ...
                                         <textarea  name="fullContent" class="form-control"><?php echo html_entity_decode($fullContent);?></textarea>
