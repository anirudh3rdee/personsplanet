                                	...
                                	<table class="table" id="myTable">
                                		 ...
                                		 <tbody>
                                            ...
                                            foreach ($allMenu as $key ) {
                                                ...
                                                //var_dump($jsonToArray->select_link_type);
                                                ?>
                         ...
                         <form method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/pages/save_menu'); ?>">
                                    ...
                                    <div class="row mb-3 align-items-center">
                                        ...
                                        <div class="col-lg-8 col-md-12" style="margin-top:0px;margin-bottom:0px;">
                                            <input type="radio" id="checkboxval1" name="link_type"  value="internal_link" onclick="selectLink('internal');"> Internal Link
                                            <input type="radio" id="checkboxval2" name="link_type" value="external_link" onclick="selectLink('external');"> External Link
                                        </div>
                                    </div>
