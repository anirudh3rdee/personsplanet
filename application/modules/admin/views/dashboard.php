            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
						<a href="<?php echo base_url('admin/pages/all_pages'); ?>">
                    ...
                    <div class="col-md-6 col-lg-4 col-xlg-3">
                        ...
                        <div class="card card-hover">
                            <div class="box bg-success text-center">
                                ...
                                <h6 class="text-white">Homepage</h6>
                            </div>
                        </div>
						</a>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
						<a href="<?php echo base_url('admin/instructionalvideos/'); ?>">
                        <div class="card card-hover">
                            <div class="box bg-info text-center">
                                <h1 class="font-light text-white"><i class="mdi mdi-relative-scale"></i></h1>
                                <h6 class="text-white">Instructional Videos</h6>
                            </div>
                        </div>
						</a>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
						<a href="<?php echo base_url('admin/pages/menu'); ?>">
                        <div class="card card-hover">
                            <div class="box bg-cyan text-center">
                                <h1 class="font-light text-white"><i class="mdi mdi-pencil"></i></h1>
                                <h6 class="text-white">Header Menu</h6>
                            </div>
                        </div>
						</a>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
						<a href="<?php echo base_url('admin/setting/header'); ?>">
                        <div class="card card-hover">
                            <div class="box bg-warning text-center">
                                <h1 class="font-light text-white"><i class="mdi mdi-alert"></i></h1>
                                <h6 class="text-white">Header Settings</h6>
                            </div>
                        </div>
						</a>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
						<a href="<?php echo base_url('admin/setting/footer_menu'); ?>">		
                        <div class="card card-hover">
                            <div class="box bg-success text-center">
                                <h1 class="font-light text-white"><i class="mdi mdi-border-outside"></i></h1>
                                <h6 class="text-white">Footer Menu</h6>
                            </div>
                        </div>
						</a>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets scrollable">
                                ...
                                <div class="d-flex flex-row comment-row m-t-0">
                                    ...
                                    <div class="p-2"><img src="<?php echo base_url(); ?>assets/admin/assets/images/users/1.jpg" alt="user" width="50" class="rounded-circle"></div>
                                ...
                                <div class="d-flex flex-row comment-row">
                                    ...
                                    <div class="p-2"><img src="<?php echo base_url(); ?>assets/admin/assets/images/users/4.jpg" alt="user" width="50" class="rounded-circle"></div>
                                ...
                                <div class="d-flex flex-row comment-row">
                                    ...
                                    <div class="p-2"><img src="<?php echo base_url(); ?>assets/admin/assets/images/users/5.jpg" alt="user" width="50" class="rounded-circle"></div>
                                    ...
                                    <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                                        ...
                                        <li class="list-group-item todo-item" data-role="task">
                                            ...
                                            <ul class="list-style-none assignedto">
                                                ...
                                                <li class="assignee"><img class="rounded-circle" width="40" src="<?php echo base_url(); ?>assets/admin/assets/images/users/1.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"></li>

                                                <li class="assignee"><img class="rounded-circle" width="40" src="<?php echo base_url(); ?>assets/admin/assets/images/users/2.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>

                                                <li class="assignee"><img class="rounded-circle" width="40" src="<?php echo base_url(); ?>assets/admin/assets/images/users/3.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>

                                                <li class="assignee"><img class="rounded-circle" width="40" src="<?php echo base_url(); ?>assets/admin/assets/images/users/4.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                                ...
                                <div class="chat-box scrollable" style="height:475px;">
                                    ...
                                    <ul class="chat-list">
                                        ...
                                        <li class="chat-item">
                                            ...
                                            <div class="chat-img"><img src="<?php echo base_url(); ?>assets/admin/assets/images/users/1.jpg" alt="user"></div>
                                        ...
                                        <li class="chat-item">
                                            ...
                                            <div class="chat-img"><img src="<?php echo base_url(); ?>assets/admin/assets/images/users/2.jpg" alt="user"></div>
                                        ...
                                        <li class="chat-item">
                                            ...
                                            <div class="chat-img"><img src="<?php echo base_url(); ?>assets/admin/assets/images/users/3.jpg" alt="user"></div>
                            ...
                            <div class="tab-content tabcontent-border">
                                ...
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    ...
                                    <div class="p-20">
                                        ...
                                        <img src="<?php echo base_url(); ?>assets/admin/assets/images/background/img4.jpg" class="img-fluid">
