    ...
    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fas fa-map-marker-alt"></i><span class="hide-menu">Location </span></a>
      ...
      <ul aria-expanded="false" class="collapse  first-level">
       ...
       <li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo base_url('admin/stylesheet'); ?>" aria-expanded="false"><i class="mdi mdi-file-image"></i><span class="hide-menu">Stylesheet </span></a></li>  
        <li class="sidebar-item"><a href="<?php echo base_url('admin/instructionalvideos/'); ?>" class="sidebar-link"><i class="mdi mdi-video"></i><span class="hide-menu">Instructional Videos</span></a></li>
        
        <li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo base_url('admin/tradestation'); ?>" aria-expanded="false"><i class="mdi mdi-file-image"></i><span class="hide-menu">Trade Station </span></a></li>  
  
        <li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo base_url('admin/pugvideos'); ?>" aria-expanded="false"><i class="mdi mdi-file-image"></i><span class="hide-menu">Pug Videos </span></a></li>
    </ul>
