                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url(); ?>admin/dashboard/">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <img src="<?php echo base_url(); ?>assets/images/logo.png" alt="homepage" class="light-logo" style='width:150px' />
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                ...
                                <a class="dropdown-item" href="<?php echo base_url('admin/setting/account_setting');?>"><i class="ti-settings m-r-5 m-l-5"></i> Account Setting</a>
