                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a class="btn btn-outline-primary" href="<?php echo base_url('admin/location/add_new/');?>" >Create New</a>
                                		 ...
                                		 <tbody>
                                            ...
                                            //  print_r($locationData);
                                             ...
                                             <tr id="row_<?php echo $key->id; ?>">
                                		 		...
                                		 		<td><?php echo $array_data['location_name']; ?></td>

                                                 <td><?php echo $array_data['location_slug']; ?></td>

                                                 <td><?php echo $array_data['location_description']; ?></td>

                                                 <td><?php echo $array_data['event_address']; ?></td>

                                                 <td><?php echo $array_data['location_latitude']; ?></td>

                                                 <td><?php echo $array_data['location_longitude']; ?></td>

                                                 <td><?php echo $array_data['thumbnail_image']; ?></td>
                                                ...
                                                <td>
			                                        ...
			                                        <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 35px, 0px);">
			                                          ...
			                                          <a class="dropdown-item" href="<?php echo base_url('admin/location/add_new_location/'.$key->id);?>">Edit</a>
